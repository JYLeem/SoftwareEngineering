...
class SignUpPage(tk.Tk):
    def __init__(self):
        ...
        self.NicknameEntry = tk.Entry(bd=0, bg="#CCCCCC", fg="#000716",  highlightthickness=0)
        self.NicknameEntry.place(x=122.0, y=177.0, width=522, height=34)

        self.CheckNicknameExistenceBtn = tk.Button(text="중복 확인", command=self.CheckNicknameExistence)
        self.CheckNicknameExistenceBtn.place(x=650.0, y=177.0, width = 60, height=34)

        self.IDEntry = tk.Entry(bd=0, bg="#CCCCCC",fg="#000716",  highlightthickness=0)
        self.IDEntry.place(x=122.0, y=240.0, width=522, height = 34)
        self.IDExistenceBtn = tk.Button(text="중복 확인", command=self.CheckIDExistence)
        self.IDExistenceBtn.place(x=650.0, y=244.0, width = 60, height=34)

        self.PasswordEntry = tk.Entry(bd=0, bg="#CCCCCC",fg="#000716",  highlightthickness=0, show='*')
        ...
        self.GoPrevPageBtn = tk.Button(text="이전으로", command=self.SwitchToLoginPage)
        self.GoPrevPageBtn.place(x=356, y=367, width=133, height=38)

        self.SignUpBtn = tk.Button(text="회원가입", command=self.SignUp)
