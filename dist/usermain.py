...
class UserMainPage(tk.Tk):
    def __init__(self, userID):
        ...
        style.configure("TButton", background="#FFFFFF", foreground="#000000", font=("Arial", 10), padding=10)  # 글자 크기를 12로 설정
        ...
        self.button2 = ttk.Button(self, text="일자별 시험", width=12, style="TButton")
        self.button2.place(x=340, y=300)

        self.button3 = ttk.Button(self, text="수뭉이 게임", width=12, style="TButton")
        self.button3.place(x=520, y=300)

        self.button4 = ttk.Button(self, text="수준별 학습", width=12, style="TButton")
        self.button4.place(x=160, y=400)

        self.button5 = ttk.Button(self, text="수준별 시험", width=12, style="TButton")
        self.button5.place(x=340, y=400)

        # Logout Button with transparent background
        self.logout_button = ttk.Button(self, text="로그아웃", width=7, style="Logout.TButton")
